...
from ultralytics.nn.modules import (
    ...
    AWAU,
    DySampleLite,
    SPPF_MixPool,SPPF_DWDilated,SPPF_ScaleGate
)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            GhostBottleneck,
            SPP,
            SPPF,SPPF_MixPool,SPPF_DWDilated,SPPF_ScaleGate,
            C2fPSA,
            C2PSA,
            DWConv,
            Focus,
            ...
            c2 = ch[f[-1]]
        elif m is DySampleLite:
            c2 = ch[f]                 # DySampleLite 不改变通道数
            args = [ch[f], *args]      # 把输入通道 c1 插到参数最前面
