...
class activation(nn.ReLU):
    """Custom activation block that mixes learnable convolution kernels with ReLU outputs."""
...
class vanillanetBlock(nn.Module):
    """vanillanet block extracted from VanillaNet, keeping parity with the original implementation."""
