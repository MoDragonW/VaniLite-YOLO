...
# 2) 路径配置
# =========================
MODEL_YAML = ROOT / "ultralytics/cfg/models/VaniLite-YOLO/YOLO-VanillaBlock.yaml"
WEIGHTS = Path(ROOT / "trained_models/yolov12n-vanillanet.pt")
DATA_YAML = Path(ROOT /  "ultralytics/cfg/datasets/renshen.yaml")
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        save_dir = ROOT / "sparsed_models" / "YOLO-VanillaBlock"
