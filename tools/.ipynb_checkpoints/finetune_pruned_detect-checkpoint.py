...
# 2) 配置区（只改这里）
# =========================
PRUNED_CKPT = "/root/YOLOv12-new/trained_models/yolov12n-vanillanet-SPPF_MixPool-pruned-sparsity0.25.pt"
DATA_YAML = "/root/YOLOv12-new/ultralytics/cfg/datasets/renshen.yaml"

SAVE_DIR = ROOT / "finetuned_models" / "yolov12n-vanillanet-SPPF_MixPool"
EPOCHS = 120
IMGSZ = 512
BATCH = 16
WORKERS = 4
