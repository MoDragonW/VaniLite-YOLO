...
# ====== 固定配置 ======
SPARSE_CKPT = "/root/YOLOv12-new/trained_models/yolov12n-vanillanet-SPPF_MixPool-sparsed.pt"
SPARSITY = 0.25
DUMMY = 64
DEVICE = "cpu"  # 推荐先 cpu；如果要 cuda 就改成 "cuda:0"
SAVE_DIR = "/root/YOLOv12-new/pruned_models/pruned_detect_depgraph"
...
def main():
    ...
    # 保存报告
    report_path = save_dir / "yolov12n-vanillanet-SPPF_MixPool.json"
    ...
    pruned_path = save_dir / "yolov12n-vanillanet-SPPF_MixPool.pt"
